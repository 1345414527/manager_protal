<template>
    <div class="topicManager">
        ...
        <!--增添对话框-->
        <topic :is-edit="false" :is-show="addDialogVisiable" @updateState="updateShow"/>
        <!--编辑对话框-->
        <topic :is-edit="true" :is-show="editDialogVisiable" :topics="editRowInfo"  @updateState="updateShow"/>
    </div>
</template>
