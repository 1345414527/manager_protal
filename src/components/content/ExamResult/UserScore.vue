<template>
    <div class="user-score">
        ...
        <el-table :data="publicTests" :stripe="true"  border max-height="550"   style="width: 100%" @sort-change="sortChange" :sort-orders="['ascending', 'descending']"
            ...
            <el-table-column prop="publicTestId" label="id" width="230" sortable="custom"></el-table-column>
            ...
            <el-table-column prop="frequency"  label="答题次数" width="120" sortable="custom" fixed="right" :formatter="frequenceFormat"></el-table-column>
        </el-table>
        <!--分页行-->
        <el-pagination
...
<script>
    import {queryAllSubscribeExamInfo} from "network/exam/subscribeExamHttp";
